...
class GUI_GroupOutputHSB extends Group {
  ...
  GUI_GroupOutputHSB(ControlP5 ctrl, String name, int xCoord, int yCoord) {
    ...
    brightnessAttributeSelector.addItem("Define", ATTRIBUTE_DEFINE);
    ...
    saturationAttributeSelector.addItem("Define", ATTRIBUTE_DEFINE);
    ...
    hueAttributeSelector.addItem("Define", ATTRIBUTE_DEFINE);
